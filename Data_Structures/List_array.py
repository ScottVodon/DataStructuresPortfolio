...
class List:
    ...
    def _is_valid_index(self, i):
        ...
        -------------------------------------------------------
        """
        rng = len(self._values)

        return i < rng and i >= -rng
    ...
    def _linear_search(self, key):
        ...
        i = -1
        k = 0
        while k < len(self._values) and i == -1:   
            if self._values[k] == key:
                i = k
            k += 1
        return i
    def _swap(self, i, j):
    ...
    def insert(self, i, value):
        ...
        list1 = self._values[0:i]
        list2 = self._values[i:]
        
        list1.append(value)
        self._values = list1 + list2
    ...
    def split(self):
        ...
        target1 = List()
        target2 = List()
        split = self.__len__() // 2
        count = 0
        while not self.is_empty():
            if count < split:
                target1.append(deepcopy(self.pop(0)))
            else:
                target2.append(deepcopy(self.pop(0)))
            count += 1
    ...
    def split_alt(self):
        ...
        while not self.is_empty():   
            if not self.is_empty():
                target1.append(deepcopy(self._values.pop(0)))
            if not self.is_empty():
                target2.append(deepcopy(self._values.pop(0)))
    ...
    def union(self, source1, source2):
        ...
        source1.clean()
        source2.clean()
        archive = deepcopy(source1._values)
